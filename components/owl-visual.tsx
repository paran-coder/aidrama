...
export function OwlVisual({
  ...
  return (
    <div className="relative grid min-h-[330px] w-full place-items-center overflow-hidden rounded-[2.2rem] border border-[var(--line)] bg-[var(--surface)]">
      ...
      <img
        ...
        className={`relative h-full w-full ${hero ? "max-h-[520px] object-cover" : "max-h-[430px] object-contain p-4 sm:p-6"}`}
      />
      {!hero && (

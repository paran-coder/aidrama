...
const checks = [
  ['version is 1.3.4', version === '1.3.4' && pkg.version === '1.3.4'],
  ...
  ['table body is larger than text-sm', admin.includes('min-w-[1080px] table-fixed text-left text-[15px]')],
  ...
  ['management actions are horizontal', admin.includes('flex items-center justify-end gap-1.5 whitespace-nowrap')],
